...
fn main() {
    ...
    let w1 = make_tensor(
        vec![
            0.1, 0.2, -0.1, 0.3, 0.05, -0.2, 0.15, 0.1, -0.3, 0.1, 0.2, -0.1, 0.4, 0.1,
            -0.05, 0.2, 0.2, -0.15, 0.3, 0.1, -0.1, 0.25, 0.1, -0.2, -0.1, 0.3, -0.2, 0.15,
            0.2, -0.1, 0.3, 0.05,
        ],
        vec![4, 8],
    );
    ...
    let w2 = make_tensor(
        vec![
            0.2, -0.1, 0.3, 0.1, 0.15, -0.2, 0.05, -0.1, -0.1, 0.3, -0.15, 0.2, 0.1, 0.2,
            -0.3, 0.1, 0.15, -0.2, 0.1, 0.25, -0.1, 0.05, 0.3, -0.15,
        ],
        vec![8, 3],
    );
    ...
    let input = make_tensor(
        vec![1.0, 0.5, -0.3, 0.8, -0.2, 1.2, 0.4, -0.6],
        vec![2, 4],
    );
