...
///
/// Run: cargo run -p arrow-kernels --example cnn_pipeline
...
use arrow_kernels::linalg::batchnorm::batch_norm;
use arrow_kernels::linalg::conv::conv2d;
use arrow_kernels::linalg::pooling::max_pool2d;
