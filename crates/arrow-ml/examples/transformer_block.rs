...
///
/// Run: cargo run -p arrow-ml --example transformer_block
use arrow::array::{Float32Array, PrimitiveArray, UInt32Array};
use arrow::buffer::Buffer;
use arrow::datatypes::Float32Type;
use arrow::tensor::Tensor;
use arrow_ml::array_ops::ArrayOps;
use arrow_ml::linalg::argmax::{argmax, argmax_tensor};
use arrow_ml::linalg::embedding::embedding;
use arrow_ml::linalg::layernorm::layer_norm;
